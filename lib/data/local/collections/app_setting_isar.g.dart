...
extension AppSettingIsarByIndex on IsarCollection<AppSettingIsar> {
  Future<AppSettingIsar?> getByKey(String key) {
    return getByIndex(r'key', [key]);
  }

  AppSettingIsar? getByKeySync(String key) {
  ...
  Future<List<AppSettingIsar?>> getAllByKey(List<String> keyValues) {
    final values = keyValues.map((e) => [e]).toList();
    return getAllByIndex(r'key', values);
  }

  List<AppSettingIsar?> getAllByKeySync(List<String> keyValues) {
    final values = keyValues.map((e) => [e]).toList();
  ...
  Future<Id> putByKey(AppSettingIsar object) {
    return putByIndex(r'key', object);
  }

  Id putByKeySync(AppSettingIsar object, {bool saveLinks = true}) {
    return putByIndexSync(r'key', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByKey(List<AppSettingIsar> objects) {
    return putAllByIndex(r'key', objects);
  }

  List<Id> putAllByKeySync(List<AppSettingIsar> objects,
      {bool saveLinks = true}) {
...
extension AppSettingIsarQueryWhere
  ...
  QueryBuilder<AppSettingIsar, AppSettingIsar, QAfterWhereClause> keyEqualTo(
      String key) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppSettingIsar, AppSettingIsar, QAfterWhereClause> keyNotEqualTo(
      String key) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
